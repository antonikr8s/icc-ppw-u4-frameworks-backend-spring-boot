...
public class AuthService {
    ...
    /*
     * Login: valida credenciales con Spring Security y retorna JWT.
     */
    ...
    /*
     * Registro: crea el usuario, le asigna ROLE_USER y retorna JWT
     * automáticamente (sin necesidad de hacer login después).
     */
    @Transactional
